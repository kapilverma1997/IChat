  ...
  const requestPermission = async () => {
    ...
    try {
      ...
      if (permission === 'granted') {
        ...
        alert('Push notifications were blocked. You can enable them later in your browser settings.');
        setShow(false);
        localStorage.setItem('pushPermissionDismissed', 'true');
      }
    } catch (error) {
    ...
    <div className={styles.overlay}>
      <div className={styles.popup}>
        ...
        <p className={styles.description}>
          Get notified about new messages, mentions, and important updates even when you're not on the site.
        </p>
